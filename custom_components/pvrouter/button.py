...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities([
        PvRouterButton(coordinator, "Reboot", TOPIC_RESET, " 1", "restart"),
        PvRouterButton(coordinator, "Switch Ballon Touch", TOPIC_SWITCH, "1", "update"),
    ])
