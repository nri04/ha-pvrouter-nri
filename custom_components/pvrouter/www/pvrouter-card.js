class PvRouterCard extends HTMLElement {
  ...
  static getStubConfig() {
    return {
      ...
      output1_name: "Sortie 1",
      output2_name: "Sortie 2",
    };
  }
  ...
  set hass(hass) {
    ...
    const fmt = (v, unit = "W") => {
      ...
      if (unit === "W") return v.toFixed(0) + " W";
    ...
    // Arrows: active if value > 5W
    const arrow = (v) => (v !== null && v > 5) ? "#03a9f4" : "#444";
    const arrowInactive = "#444";

    this.innerHTML = `
      <ha-card>
        <div class="card-header">⚡ PvRouter NRI – Live</div>
        <div class="pv-grid">
          ...
          <!-- Arrow down from solar -->
          <div class="pv-cell mid-center">
            <div class="pv-arrow-v" style="color:${arrow(prod)}">▼</div>
            <div class="pv-eff">${eff !== null ? eff.toFixed(1) + "%" : "—"}<br><small>Efficacité</small></div>
            <div class="pv-arrow-v" style="color:${arrow(pout)}">▼</div>
          </div>

          <!-- Output 1 (bottom left) -->
          <div class="pv-cell bot-left">
            <div class="pv-arrow-h" style="color:${arrow(load1)}">◀</div>
          ...
          <div class="pv-cell bot-right">
            ...
            <div class="pv-arrow-h" style="color:${arrow(load2)}">▶</div>
          </div>
        ...
        <style>
          ...
          .pv-arrow-v { font-size: 1.4em; line-height: 1; transition: color 0.3s; }
          .pv-arrow-h { font-size: 1.4em; line-height: 1; transition: color 0.3s; }
